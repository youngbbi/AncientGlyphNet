...
class ResNet(nn.Module):
    def __init__(self, block, layers, in_channels=3, dcn=None):
        ...
        self.layer1 = self._make_layer1(block, 64, layers[0], stride=2, dcn=dcn)
    ...
    def _make_layer1(self, block, planes, blocks, stride=1, dcn=None):
        downsample = None
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample =  Down_wt(self.inplanes, planes * block.expansion)
